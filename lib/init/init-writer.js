      ...
      job.ecsStream = {
        write: function (data) {
          process.nextTick(function () {
            ...
            // job.byteWritten += Buffer.byteLength(data, 'utf8');
            client.hincrby(jobRedisKey, 'byteWritten', Buffer.byteLength(data, 'utf8'));
          });
        },
        end: function () {
          job.logger.info("Temp file for deferred download completly writen");
          client.hset(jobRedisKey, 'ecsStreamEnd', true);
        }
      };
